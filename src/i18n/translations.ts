...
export const translations = {
  fr: {
    ...
    pricing: {
      ...
      popular: 'Populaire',
      perMonth: '/mois',
      freePlan: { price: '0', features: ['15 transactions/mois', '1 compte', '1 budget', 'Tableau de bord basique', '5 catégories'] },
      premiumPlan: { price: '4,99€', features: ['Transactions illimitées', 'Comptes illimités', 'Budgets illimités', 'Catégories illimitées', 'Prévisions IA', 'Rapports avancés & exports', 'Gestion familiale', "Objectifs d'épargne", 'Support prioritaire'] },
  ...
  en: {
    ...
    pricing: {
      ...
      freePlan: { price: '0', features: ['15 transactions/month', '1 account', '1 budget', 'Basic dashboard', '5 categories'] },
      premiumPlan: { price: '$4.99', features: ['Unlimited transactions', 'Unlimited accounts', 'Unlimited budgets', 'Unlimited categories', 'AI forecasts', 'Advanced reports & exports', 'Family management', 'Savings goals', 'Priority support'] },
