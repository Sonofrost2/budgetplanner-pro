          ...
          {goals.length === 0 ? (
            ...
            <div className="space-y-3">
              {goals.map(goal => {
                ...
                return (
                  <div key={goal.id} className="space-y-1.5 p-2 rounded-xl hover:bg-muted/20 active:scale-[0.98] transition-all cursor-pointer" onClick={() => navigate('/dashboard/savings')}>
