...
const receipt = { id:'a1b2c3d4-e5f6-7890-abcd-ef1234567890', plan_name:'pro', amount:8990, currency:'XOF', status:'confirmed', payment_token:'5cqxd05g80abc', created_at:'2026-05-02T01:12:00Z' };
...
doc.text(sanitizePdfText(`(c) ${new Date().getFullYear()} Budget Planner Pro - support@budget-planner-pro.eurekaci.dev`),pageW/2,pageH-10,{align:'center'});
